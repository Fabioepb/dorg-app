export const AAVE_V3_SUPPLY_ETH_ABI = [
  {
    inputs: [
...
// Aave V3 Pool ABI - contains the supplyWithPermit function
...
export const AAVE_V3_SUPPLY_TOKEN_ABI = [
  {
    inputs: [
      {
